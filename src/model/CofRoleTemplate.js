...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.XgeneCloud.CofRoleTemplate = factory(root.XgeneCloud.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The CofRoleTemplate model module.
   * @module model/CofRoleTemplate
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>CofRoleTemplate</code>.
   * @alias module:model/CofRoleTemplate
   * @class
   */
  ...
  /**
   * Constructs a <code>CofRoleTemplate</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CofRoleTemplate} obj Optional instance to populate.
   * @return {module:model/CofRoleTemplate} The populated <code>CofRoleTemplate</code> instance.
   */
