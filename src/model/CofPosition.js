...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.XgeneCloud.CofPosition = factory(root.XgeneCloud.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The CofPosition model module.
   * @module model/CofPosition
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>CofPosition</code>.
   * @alias module:model/CofPosition
   * @class
   */
  ...
  /**
   * Constructs a <code>CofPosition</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CofPosition} obj Optional instance to populate.
   * @return {module:model/CofPosition} The populated <code>CofPosition</code> instance.
   */
