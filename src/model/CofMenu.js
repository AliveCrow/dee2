...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.XgeneCloud.CofMenu = factory(root.XgeneCloud.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The CofMenu model module.
   * @module model/CofMenu
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>CofMenu</code>.
   * @alias module:model/CofMenu
   * @class
   */
  ...
  /**
   * Constructs a <code>CofMenu</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CofMenu} obj Optional instance to populate.
   * @return {module:model/CofMenu} The populated <code>CofMenu</code> instance.
   */
