...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.XgeneCloud.CofDictType = factory(root.XgeneCloud.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The CofDictType model module.
   * @module model/CofDictType
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>CofDictType</code>.
   * @alias module:model/CofDictType
   * @class
   */
  ...
  /**
   * Constructs a <code>CofDictType</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CofDictType} obj Optional instance to populate.
   * @return {module:model/CofDictType} The populated <code>CofDictType</code> instance.
   */
