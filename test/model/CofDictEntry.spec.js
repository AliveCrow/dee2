...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CofDictEntry', function() {
      beforeEach(function() {
        instance = new XgeneCloud.CofDictEntry();
      });

      it('should create an instance of CofDictEntry', function() {
        // TODO: update the code to test CofDictEntry
        expect(instance).to.be.a(XgeneCloud.CofDictEntry);
      });
