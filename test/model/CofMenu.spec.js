...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CofMenu', function() {
      beforeEach(function() {
        instance = new XgeneCloud.CofMenu();
      });

      it('should create an instance of CofMenu', function() {
        // TODO: update the code to test CofMenu
        expect(instance).to.be.a(XgeneCloud.CofMenu);
      });
