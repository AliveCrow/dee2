...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CofDictType', function() {
      beforeEach(function() {
        instance = new XgeneCloud.CofDictType();
      });

      it('should create an instance of CofDictType', function() {
        // TODO: update the code to test CofDictType
        expect(instance).to.be.a(XgeneCloud.CofDictType);
      });
