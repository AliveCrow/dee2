...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CofResGroup', function() {
      beforeEach(function() {
        instance = new XgeneCloud.CofResGroup();
      });

      it('should create an instance of CofResGroup', function() {
        // TODO: update the code to test CofResGroup
        expect(instance).to.be.a(XgeneCloud.CofResGroup);
      });
