...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CofRoleTemplateGroup', function() {
      beforeEach(function() {
        instance = new XgeneCloud.CofRoleTemplateGroup();
      });

      it('should create an instance of CofRoleTemplateGroup', function() {
        // TODO: update the code to test CofRoleTemplateGroup
        expect(instance).to.be.a(XgeneCloud.CofRoleTemplateGroup);
      });
