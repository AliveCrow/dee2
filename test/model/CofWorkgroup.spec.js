...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CofWorkgroup', function() {
      beforeEach(function() {
        instance = new XgeneCloud.CofWorkgroup();
      });

      it('should create an instance of CofWorkgroup', function() {
        // TODO: update the code to test CofWorkgroup
        expect(instance).to.be.a(XgeneCloud.CofWorkgroup);
      });
