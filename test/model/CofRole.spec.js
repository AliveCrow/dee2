...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CofRole', function() {
      beforeEach(function() {
        instance = new XgeneCloud.CofRole();
      });

      it('should create an instance of CofRole', function() {
        // TODO: update the code to test CofRole
        expect(instance).to.be.a(XgeneCloud.CofRole);
      });
      ...
      it('should have the property ROLE_TPL_ID (base name: "ROLE_TPL_ID")', function() {
        // TODO: update the code to test the property ROLE_TPL_ID
        expect(instance).to.have.property('ROLE_TPL_ID');
        // expect(instance.ROLE_TPL_ID).to.be(expectedValueLiteral);
      });
